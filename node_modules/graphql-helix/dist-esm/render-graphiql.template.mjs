...
export const renderGraphiQL = (options = {}) => {
    const { defaultQuery, defaultVariableEditorOpen, endpoint, headers, headerEditorEnabled, nonce, subscriptionsEndpoint, useWebSocketLegacyProtocol, hybridSubscriptionTransportConfig, } = options;
